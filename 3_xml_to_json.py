"""
reference: https://blog.roboflow.com/how-to-convert-annotations-from-voc-xml-to-coco-json/
"""
...
def main():
    ...
    parser.add_argument(
        "--output", type=str, default="train.json", help="path to output json file"
    )
    parser.add_argument(
